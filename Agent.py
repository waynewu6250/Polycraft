...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed):
        ...
        # Replay memory
        self.memory = ScreenReplayBuffer(100000, 4)
    ...
    def select_act(self, state, eps=0.):
        ...
        state = torch.from_numpy(recent_observations).float().unsqueeze(0).to(device) 
    ...
    def learn(self,experiences,gamma):
        ...
        Q_expected = self.qnetwork_local(states).gather(1,actions.unsqueeze(0))
